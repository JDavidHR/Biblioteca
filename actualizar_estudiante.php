...
<body class="animsition">
    ...
    $seleccionestudiante =$mysql->efectuarConsulta("SELECT biblioteca3.estudiantes.id_estudiante,biblioteca3.estudiantes.nombre from estudiantes  where biblioteca3.estudiantes.estado = 1");
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="actualizar_estudiante_part2.php" method="POST">
                                ...
                                <br><br>
                                <button type="submit" name="actualizar" class="au-btn au-btn--block au-btn--green m-b-20">Actualizar Estudiante</button>
