...
$mostrardatos =$mysql->efectuarConsulta("SELECT id11714256_biblioteca3.programa.programa FROM programa WHERE id11714256_biblioteca3.programa.id_programa = ".$id."");
