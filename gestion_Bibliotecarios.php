                ...
                <div class="col-5-lg-5">
                    <div class="table-responsive table--no-card m-b-30">
                            ...
                            <!--creacion de los botones-->
                             <center><a href="eliminar_bibliotecario.php" class="au-btn au-btn-- au-btn--green m-b-20" style="text-align: center;">Eliminar  Bibliotecario</a>

                              <a href="actualizar_bibliotecario.php" class="au-btn au-btn-- au-btn--green m-b-20" style="text-align: center;">Actualizar  Bibliotecario</a>

                               <a href="register_bibliotecario.php" class="au-btn au-btn-- au-btn--green m-b-20" style="text-align: center;">Añadir Bibliotecario</a></center>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#tablaDatatable').load('tablas/tabla_gestion_bibliotecarios.php');
    });
</script>
</body>
