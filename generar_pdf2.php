                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12"><!--informacion mostrada en la pagina del bibliotecario-->
                                <form action="PDF/prueba2.php" method="POST">
                                    <center>
                                    ...
                                    <br><br>
                                    <button type="submit" name="generar" class="au-btn au-btn--block au-btn--green m-b-20">Prestamo Usuario Cualquiera</button></a>
                                    </center>
                                </form>
                            </div>
                        </div>
