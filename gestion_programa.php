          ...
          ?>    
            ...
            <div class="main-content">
                            ...
                            <!--creacion de la etiqueta como funcion de boton donde se redireccionaran las paginas-->
                             <center><a href="eliminar_programa.php" class="au-btn au-btn-- au-btn--green m-b-20" style="text-align: center;">Eliminar Programa</a>

                              <a href="actualizar_programa.php" class="au-btn au-btn-- au-btn--green m-b-20" style="text-align: center;">Actualizar Programa</a>

                               <a href="anadir_programa.php" class="au-btn au-btn-- au-btn--green m-b-20" style="text-align: center;">Añadir Programa</a></center>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
