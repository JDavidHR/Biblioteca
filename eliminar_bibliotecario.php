...
<body class="animsition">
    ...
    $seleccionestudiante =$mysql->efectuarConsulta("SELECT id11714256_biblioteca3.bibliotecario.id_bibliotecario,id11714256_biblioteca3.bibliotecario.nombre from bibliotecario where id11714256_biblioteca3.bibliotecario.estado = 1");
