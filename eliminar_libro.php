                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="controlador/delete_libro.php" method="POST">
                                <h1 align="center" class="au-input au-input--full">Bienvenido Bibliotecario</h1>
                                <br>
                                <label>seleccione el libro a eliminar</label>
                                <br>
                                ...
                                <br><br>
                                <button type="submit" name="eliminar" class="au-btn au-btn--block au-btn--green m-b-20">Eliminar Libro</button>
