                ...
                <div class="col-5-lg-5">
                    <div class="table-responsive table--no-card m-b-30">
                            ...
                            <!--creacion de la etiqueta con funcion de boton para redireccionar a las paginas-->
                             <center><a href="eliminar_libro.php" class="au-btn au-btn-- au-btn--green m-b-20" style="text-align: center;">Eliminar Libro</a>

                              <a href="actualizar_libro.php" class="au-btn au-btn-- au-btn--green m-b-20" style="text-align: center;">Actualizar Libro</a>

                              <a href="anadir_libro.php" class="au-btn au-btn-- au-btn--green m-b-20" style="text-align: center;">Añadir Libro</a></center>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <?php
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#tablaDatatable').load('tablas/tabla_gestion_libros.php');
    });
</script>
</body><!--fin cuerpo de la pagina-->
