...
<head>
    ...
    <!-- Title Page-->
    <title>Actualizar credito</title>
                        ...
                        <div class="login-form">
                            <form action="creditos.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="doc_bibliotecario" placeholder="Documento Bibliotecario">
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit">Actualizar Credito</button>
