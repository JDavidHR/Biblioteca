...
$prestamo = $_POST['seleccion_prestamo'];


//declaracion de la variable donde se almacena la funcion de mysql.php donde se hara la respectiva consulta
$consulta =$mysql->efectuarConsulta("UPDATE prestamos SET estado = 0 where id_prestamo = ".$prestamo."");


if($consulta){
//mensaje de salida en caso de que la consulta sea exitosa con su respectiva redireccion de pagina
//echo"<script type=\"text/javascript\">alert('Se elimino correctamente!'); window.location='../prestamo_Bibliotecario.php';</script>";
echo"<div class=\"alert alert-success  role=\"alert\"><a href=\"../prestamo_Bibliotecario.php\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a><strong>!Se elimino correctamente!</strong></div>";
...
//echo"<script type=\"text/javascript\">alert('Se produjo un error'); window.location='../eliminar_prestamo.php';</script>";
}
?>
</div>
    <!-- Main JS-->
