...
if(isset($_POST['añadir']) && !empty($_POST['titulo']) && !empty($_POST['bibliotecario']) && !empty($_POST['estudiante']) && !empty($_POST['fecha'])){
        ...
        $sql=$mysql->efectuarConsulta("insert into id11714256_biblioteca3.prestamos(fecha_prestamo,bibliotecario_id_bibliotecario,estudiantes_id_estudiante,libros_id_libro,estado) VALUES ('".$fecha."','".$bibliotecario."','".$estudiante."','".$titulo."',1)");
